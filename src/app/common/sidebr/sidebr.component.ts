  ...
  { name: 'Charts Visualization', icon: 'chart', path: '/dashboard/chartvisualization' },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { name: 'Performance Dashboard', icon: '', path: '/dashboard' },
          { name: 'Process Dashboard',     icon: '', path: '/home' },
          { name: 'Recommendations',       icon: '', path: '/recommendationsList' },
          { name: 'Alerts',                icon: '', path: '/alertList' },
          { name: 'Equipment',             icon: '', path: '/equipmentList' },
          { name: 'Tag List',              icon: '', path: '/disturbanceOrder' },
          { name: 'Admin Page',            icon: '', path: '/adminpage' },
          { name: 'Control Range Page',    icon: '', path: '/controlRange' },
        ],
      },
    ],
  },
